...
- Analysis (strategy, human-authored, updated independently): `../analysis/california-impute-direct/STRATEGY.md`
- Source JSON: `../analysis/california-impute-direct/band_supports.json`
