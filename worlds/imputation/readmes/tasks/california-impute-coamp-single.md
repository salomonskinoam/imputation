...
- Analysis (strategy, human-authored, updated independently): `../analysis/california-impute-coamp-single/STRATEGY.md`
- Source JSON: `../analysis/california-impute-coamp-single/band_supports.json`
