...
- Analysis (strategy, human-authored, updated independently): `../analysis/bank-impute-cat-single/STRATEGY.md`
- Source JSON: `../analysis/bank-impute-cat-single/band_supports.json`
