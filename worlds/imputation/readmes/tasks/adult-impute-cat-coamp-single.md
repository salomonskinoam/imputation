...
- Analysis (strategy, human-authored, updated independently): `../analysis/adult-impute-cat-coamp-single/STRATEGY.md`
- Source JSON: `../analysis/adult-impute-cat-coamp-single/band_supports.json`
