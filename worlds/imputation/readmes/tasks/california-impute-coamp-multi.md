...
- Analysis (strategy, human-authored, updated independently): `../analysis/california-impute-coamp-multi/STRATEGY.md`
- Source JSON: `../analysis/california-impute-coamp-multi/band_supports.json`
