...
- Analysis (strategy, human-authored, updated independently): `../analysis/covertype-impute-coamp-single/STRATEGY.md`
- Source JSON: `../analysis/covertype-impute-coamp-single/band_supports.json`
