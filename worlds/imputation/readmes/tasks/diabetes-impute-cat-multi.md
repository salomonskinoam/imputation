...
- Analysis (strategy, human-authored, updated independently): `../analysis/diabetes-impute-cat-multi/STRATEGY.md`
- Source JSON: `../analysis/diabetes-impute-cat-multi/band_supports.json`
