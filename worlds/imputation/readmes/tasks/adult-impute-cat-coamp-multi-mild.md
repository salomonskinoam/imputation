...
- Analysis (strategy, human-authored, updated independently): `../analysis/adult-impute-cat-coamp-multi-mild/STRATEGY.md`
- Source JSON: `../analysis/adult-impute-cat-coamp-multi-mild/band_supports.json`
