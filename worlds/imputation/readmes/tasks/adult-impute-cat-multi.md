...
- Analysis (strategy, human-authored, updated independently): `../analysis/adult-impute-cat-multi/STRATEGY.md`
- Source JSON: `../analysis/adult-impute-cat-multi/band_supports.json`
