...
**This doc is SDK-owned and regenerable, not hand-maintained.** The master table below and one per-task
...
For the intrinsically-clustered covertype co-amp tasks the static ruler is optimistic, so their verdict is
world-authored (the runs bunch in occupancy); the `#band_supports` shown is the static capacity.

## Master table

| task | metric | band | spread | #obs / #supports | verdict | submit | links |
|---|---|---|---|---|---|---|---|
| california-impute-direct | recovery | 0.364–0.523 | **0.158** | 5 / **14.11** | viable: #band_supports = 14.1 | **YES** | [task](https://horizon.bespokelabs.ai/tasks/76263f44-25bb-48a4-82f1-6383a214e8f8) · [eval](https://horizon.bespokelabs.ai/evaluations/41ae826f-3fec-4b9a-938e-bbcbd0e225df) · [record](tasks/california-impute-direct.md) |
| covertype-impute-direct-single | recovery | 0.620–0.710 (endpoints only, not downloaded) | **0.090** | 2 / **17.45** | viable: #band_supports = 17.5 | **YES** | [task](https://horizon.bespokelabs.ai/tasks/6ed892d5-8d1b-49f2-b70e-df65a6957813) · [record](tasks/covertype-impute-direct-single.md) |
| california-impute-coamp-single | recovery | 0.151–0.262 | **0.111** | 4 / **7.46** | viable: #band_supports = 7.5 | **YES** | [task](https://horizon.bespokelabs.ai/tasks/f771caff-3d94-42f6-9804-7751bb1e06af) · [eval](https://horizon.bespokelabs.ai/evaluations/0253d895-67be-40b9-a006-15d66a821a7f) · [record](tasks/california-impute-coamp-single.md) |
| covertype-impute-coamp-single | recovery | 0.533–0.610 | **0.077** | 3 / **12.07** | clustered high, endpoints < 2 LSD apart; covertype recovery is intrinsically convergent | NO (clustered) | [task](https://horizon.bespokelabs.ai/tasks/d6237f92-5541-495d-a90e-25316f0247b1) · [eval](https://horizon.bespokelabs.ai/evaluations/63093dca-ac27-48ad-891b-b0485a5c4d63) · [record](tasks/covertype-impute-coamp-single.md) |
| california-impute-direct-multi | recovery | 0.400–0.600 (endpoints only, not downloaded) | **0.200** | 2 / **27.08** | viable: #band_supports = 27.1 | **YES** | [task](https://horizon.bespokelabs.ai/tasks/596e923b-bb5d-4dd8-af48-19a2227c0ee0) · [record](tasks/california-impute-direct-multi.md) |
| covertype-impute-direct | recovery | 0.271–0.385 | **0.114** | 4 / **18.97** | viable: #band_supports = 19.0 | **YES** | [task](https://horizon.bespokelabs.ai/tasks/ff227290-a39d-4cf8-a162-4d79b580743f) · [eval](https://horizon.bespokelabs.ai/evaluations/c56b6c86-36e5-45da-9f9b-8d40ae038f2b) · [record](tasks/covertype-impute-direct.md) |
| california-impute-coamp-multi | recovery | 0.270–0.395 | **0.124** | 5 / **13.14** | viable: #band_supports = 13.1 | **YES** | [task](https://horizon.bespokelabs.ai/tasks/ef7addc9-3664-4b21-814d-75d9ae0a8080) · [eval](https://horizon.bespokelabs.ai/evaluations/ba56e09b-b0fb-4c2e-a7ae-49bdcbef8fdc) · [record](tasks/california-impute-coamp-multi.md) |
| covertype-impute-coamp-multi | recovery | 0.288–0.329 | **0.041** | 3 / **7.33** | narrow cluster; covertype's redundant residual lets all strong models converge | NO (clustered) | [task](https://horizon.bespokelabs.ai/tasks/9e443879-143e-43f7-a6cb-6c57bdb03239) · [eval](https://horizon.bespokelabs.ai/evaluations/5114329d-9b82-4d24-8759-5cf8031a7f44) · [record](tasks/covertype-impute-coamp-multi.md) |
| adult-impute-cat-single | recovery | 0.228–0.246 | **0.018** | 2 / **2.63** | occupation single converges: one classifier recipe -> shared MI ceiling ~0.24 | NO (converged) | [task](https://horizon.bespokelabs.ai/tasks/afba95ba-144c-47bb-9f1b-6707c4eb67fe) · [eval](https://horizon.bespokelabs.ai/evaluations/2be818d8-dd93-4f9b-9143-87112ac09d76) · [record](tasks/adult-impute-cat-single.md) |
| bank-impute-cat-single | recovery | 0.232–0.269 | **0.037** | 2 / **3.52** | job single converges on a 2nd dataset (four runs bunched ~0.233), confirms single-cat convergence | NO (converged) | [task](https://horizon.bespokelabs.ai/tasks/970837ef-cf77-4717-b134-e5f8b5dd5ffc) · [eval](https://horizon.bespokelabs.ai/evaluations/ec944173-61c8-4030-ab90-96a2d938d93b) · [record](tasks/bank-impute-cat-single.md) |
| adult-impute-cat-coamp-single-occ | recovery | 0.091–0.168 | **0.077** | 3 / **7.97** | viable: #band_supports = 8.0 | **YES** | [task](https://horizon.bespokelabs.ai/tasks/4d90aba0-2d22-4973-b3d4-204d9f813f24) · [eval](https://horizon.bespokelabs.ai/evaluations/56635973-4eea-4d80-9bde-f765ae6f7e9e) · [record](tasks/adult-impute-cat-coamp-single-occ.md) |
...
| adult-impute-cat-multi | recovery | 0.365–0.449 | **0.084** | 3 / **7.78** | viable: #band_supports = 7.8 | **YES** | [task](https://horizon.bespokelabs.ai/tasks/fe13c0a7-39dc-4bbe-95b2-eae213467db3) · [eval](https://horizon.bespokelabs.ai/evaluations/b7da47bf-8993-46b4-a1fc-b692b070602e) · [record](tasks/adult-impute-cat-multi.md) |
| bank-impute-cat-multi | recovery | 0.142–0.227 | **0.085** | 3 / **7.64** | viable: #band_supports = 7.6 | **YES** | [task](https://horizon.bespokelabs.ai/tasks/f38b591d-24f3-438a-8f52-db48b286c6ea) · [eval](https://horizon.bespokelabs.ai/evaluations/175c88fc-d0ca-41e6-ad7f-30bdcdcfd22a) · [record](tasks/bank-impute-cat-multi.md) |
| adult-impute-cat-coamp-multi-mild | recovery | 0.292–0.368 | **0.076** | 4 / **7.12** | viable: #band_supports = 7.1 | **YES** | [task](https://horizon.bespokelabs.ai/tasks/d78859a7-2bf0-4ceb-b54f-79bdd5718d4c) · [eval](https://horizon.bespokelabs.ai/evaluations/366d5ba6-60b7-4f2d-8f2c-2f132013f325) · [record](tasks/adult-impute-cat-coamp-multi-mild.md) |
| bank-impute-cat-coamp-multi-mild | recovery | 0.065–0.119 | **0.054** | 3 / **5.26** | viable: #band_supports = 5.3 | **YES** | [task](https://horizon.bespokelabs.ai/tasks/aaf3e2af-455c-41cd-ad9d-b622be25f6d6) · [eval](https://horizon.bespokelabs.ai/evaluations/f834e331-1ae0-4063-b789-8cbc4193cb4a) · [record](tasks/bank-impute-cat-coamp-multi-mild.md) |
...
## Grid map (2 datasets x 2^3 slots)

Three INPUT knobs, each changing the SKILL taught (README_general_direction §15): **type**
(numeric/categorical) x **# columns** (single/multi) x **co-amputate** (no/yes) = 8 slots, realized on 2
datasets each = 16 cells. Numeric = California + Covertype; categorical = Adult + Bank. Every cell has a
verdict; see the master table above for its numbers, and its record for the analysis.

| type | #cols | co-amp | dataset | task | status |
|---|---|---|---|---|---|
| Num | Single | No  | California | california-impute-direct | WORKS |
| Num | Single | No  | Covertype  | covertype-impute-direct-single | WORKS (clustered) |
| Num | Single | Yes | California | california-impute-coamp-single | WORKS |
| Num | Single | Yes | Covertype  | covertype-impute-coamp-single | ELIMINATED (clustered) |
| Num | Multi  | No  | California | california-impute-direct-multi | WORKS |
| Num | Multi  | No  | Covertype  | covertype-impute-direct | WORKS |
| Num | Multi  | Yes | California | california-impute-coamp-multi | WORKS |
| Num | Multi  | Yes | Covertype  | covertype-impute-coamp-multi | ELIMINATED (clustered) |
| Cat | Single | No  | Adult | adult-impute-cat-single | MARGINAL (converged) |
| Cat | Single | No  | Bank  | bank-impute-cat-single | MARGINAL (converged) |
| Cat | Single | Yes | Adult | adult-impute-cat-coamp-single-occ | WORKS (salvage; low-card attempt floored) |
| Cat | Single | Yes | Bank  | bank-impute-cat-coamp-single-job | FLOORED |
| Cat | Multi  | No  | Adult | adult-impute-cat-multi | WORKS |
| Cat | Multi  | No  | Bank  | bank-impute-cat-multi | WORKS |
| Cat | Multi  | Yes | Adult | adult-impute-cat-coamp-multi-mild | WORKS |
| Cat | Multi  | Yes | Bank  | bank-impute-cat-coamp-multi-mild | WORKS (bimodal) |

Superseded / documented dead-ends (kept as records, not grid cells): `adult-impute-cat-coamp-single`
(relationship K=6, floored -> replaced by the occupation salvage), `bank-impute-cat-coamp-single`
(education K=4, floored -> replaced by the job attempt), `adult-impute-cat-coamp-multi` (co-amputating both
educ predictors over-hardened -> converged; the mild variant is the WORKS one). Extra modality:
`diabetes-impute-cat-multi` (clinical, converged ~0.27). Not in the grid: `covertype-impute` (downstream
macro-F1; flat 0.48-0.50, PARKED).
